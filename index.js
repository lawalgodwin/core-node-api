...
const httpServer = http.createServer((req, res) => {
    ...
    req.on('end', () => {
        ...
        const chosenHandler = typeof (router[trimedPath]) !== 'undefined' ? router[trimedPath] : routeHandler.notfound;
...
const router = {}
// ping route and handler
router["ping"] = routeHandler.ping
// books route and handler
router["books"] = routeHandler.Books
// user registration route and handler
router["users"] = routeHandler.Users

// user borrow and return request route and handler

router["users/request"] = routeHandler.UserRequests
